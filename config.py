...
DEFAULT_RUNS_DIR_NAME = (
    "yolo_runs"  # Subdirectory within APP_DIR for YOLO training outputs
)
...
# --- <<< ADDED: Training Trigger Enables >>> ---
DEFAULT_TRAIN_TRIGGER_20_ENABLED = True  # ADDED: Default for 20 image trigger
DEFAULT_TRAIN_TRIGGER_100_ENABLED = True  # ADDED: Default for 100 image trigger
# --- <<< END ADDED >>> ---
...
SETTING_KEYS = {
    ...
    # --- <<< ADDED: Training Trigger Enable Keys >>> ---
    "training.trigger_20_enabled": "training.trigger_20_enabled",  # ADDED
    "training.trigger_100_enabled": "training.trigger_100_enabled",  # ADDED
    # --- <<< END ADDED >>> ---
    # Augmentations
...
def get_default_settings():
    ...
    return {
        ...
        # --- <<< ADDED: Training Trigger Defaults >>> ---
        SETTING_KEYS[
            "training.trigger_20_enabled"
        ]: DEFAULT_TRAIN_TRIGGER_20_ENABLED,  # ADDED
        SETTING_KEYS[
            "training.trigger_100_enabled"
        ]: DEFAULT_TRAIN_TRIGGER_100_ENABLED,  # ADDED
        # --- <<< END ADDED >>> ---
        # Augmentations
